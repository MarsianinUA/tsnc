...
- Exports functions for generated code as `proc "c"` with `@(export)`: allocation, GC, strings, arrays, tagged values, console, runtime errors. Each exported function sets the Odin context first.
